...
- **`allowedComponents`** takes prefix-free collection IRIs (`/component/navigation_links`); the synchroniser adds the prefix. **Omitted means "leave it"; `null` clears** ([#303](https://github.com/components-web-app/cwa-nuxt-module/issues/303)). Never pass PHP FQCNs.
