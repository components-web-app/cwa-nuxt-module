<template>
  <div class="cwa-rounded-lg cwa-py-1.5 cwa-relative cwa-border cwa-bg-dark/90 cwa-border-stone-700 focus-within:cwa-bg-dark focus-within:cwa-border-stone-600">
    ...
    <input
      ...
      class="cwa-flex cwa-transition-colors cwa-relative cwa-px-4 cwa-pt-6 cwa-pb-0 cwa-text-left cwa-text-light cwa-w-full cwa-border-0 cwa-items-center cwa-bg-transparent focus:cwa-ring-0"
    >
  </div>
</template>
