    ...
    <div class="cwa-flex cwa-space-x-8">
      <div class="cwa-flex-grow">
        <FilterFormWrapper label="Search" input-id="search-input">
          <input id="search-input" type="text" class="cwa-transition-colors cwa-peer cwa-bg-light/10 focus:cwa-bg-light/15 cwa-rounded-lg cwa-border-none focus:cwa-ring-0 cwa-w-full">
