...
useHead({
  bodyAttrs: {
    class: 'cwa-h-full cwa-bg-white dark:cwa-bg-black',
  },
  htmlAttrs: {
    class: 'cwa-h-full',
  },
...
<template>
  <div class="cwa-h-full cwa-relative cwa-z-10">
    <CwaUiBackgroundParticles class="cwa-absolute cwa-inset-0 -cwa-z-10 cwa-opacity-30 cwa-invert dark:cwa-invert-0" />
    <main class="cwa-h-full cwa-flex cwa-flex-col cwa-p-6 lg:cwa-p-8">
      <div class="cwa-flex cwa-justify-center cwa-grow cwa-h-full cwa-items-center">
        <div class="cwa-text-center">
          ...
          <h1 class="cwa-mt-4 text-balance cwa-text-4xl cwa-font-semibold cwa-tracking-tight cwa-text-gray-900 dark:cwa-text-stone-100 sm:cwa-text-6xl">
            {{ statusMessage }}
          </h1>
          ...
          <div
            v-if="stack"
            class="cwa-text-left cwa-bg-black/5 cwa-bg-white dark:cwa-bg-white/10 cwa-flex-1 cwa-h-auto cwa-overflow-y-auto cwa-rounded-md cwa-text-stone-400 cwa-mt-8"
          >
            <pre
