<template>
  ...
  >
    <div v-if="props.show" role="status" v-bind="$attrs">
      <svg aria-hidden="true" class="cwa-w-6 cwa-h-6 cwa-text-gray-300 cwa-animate-spin-fast cwa-fill-blue-600" viewBox="0 0 100 101" xmlns="http://www.w3.org/2000/svg">
