...
export default class Cwa {
  ...
  constructor (nuxtApp: NuxtApp, options: CwaModuleOptions) {
    ...
    this.apiDocumentation = new ApiDocumentation(this.apiUrl, this.storage.stores.apiDocumentation)
    this.mercure = new Mercure(this.storage.stores.mercure, this.storage.stores.resources, this.storage.stores.fetcher)
    this.fetcher = new Fetcher(this.apiUrl, this.storage.stores.fetcher, this.storage.stores.resources, nuxtApp._route, this.mercure, this.apiDocumentation)
  }
