    ...
    <div>
      ...
      <form @submit.prevent="userLogin">
        <div>
          ...
          <input v-model="login.username" type="text" placeholder="E.g. hello@cwa.rocks">
        </div>
        <div>
...
.login-page
  ...
  input
    border: 0
    height: 4.8rem
    padding: 1.1rem 1.0rem 1.2rem // This vertically centers text on FF, ignored by Webkit
    font-size: 1.5rem
    &::placeholder
      font-style: italic
