...
export class Storage {
  ...
  findDraftIri(iri) {
    ...
    if (resource._metadata?.publishable?.published === false) {
      return iri
    }
    ...
    if (draftResource._metadata?.publishable?.published === false) {
  ...
  findPublishedIri(iri) {
    ...
    if (resource?._metadata?.publishable?.published === true) {
      return iri
    }
    return null
  }
